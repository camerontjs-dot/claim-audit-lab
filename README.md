...
| | |
|---|---|
| Distribution | Released `0.5.0`; unreleased `0.6.0` production-intent candidate under qualification |
...
| Release tag | `v0.5.0`; the `0.6.0` candidate is not tagged, merged, or authorized for release |
...
The unreleased `0.6.0` production-intent candidate adds the separately qualified typed CAL V1
surface documented in [the production-candidate note](docs/cal-v1-production-candidate.md).
