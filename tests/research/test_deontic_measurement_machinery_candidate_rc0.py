from research.deontic_measurement_machinery_rc0.candidate import INSTRUMENTS
from research.deontic_measurement_machinery_rc0.cohort import CASES
from research.deontic_measurement_machinery_rc0.evaluator import evaluate, metamorphic_failures
...
def test_at_least_one_machinery_path_is_qualifiable_for_gate1b() -> None:
...
def test_qualifiable_paths_pass_frozen_metamorphic_controls() -> None:
    reports = {name: evaluate(strategy) for name, strategy in INSTRUMENTS.items()}
