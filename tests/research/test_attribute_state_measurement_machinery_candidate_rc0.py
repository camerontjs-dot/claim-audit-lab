from research.attribute_state_measurement_machinery_rc0.candidate import INSTRUMENTS
from research.attribute_state_measurement_machinery_rc0.cohort import CASES
from research.attribute_state_measurement_machinery_rc0.evaluator import evaluate, metamorphic_failures
...
def test_at_least_one_path_is_qualifiable() -> None:
