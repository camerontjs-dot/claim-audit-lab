...
from claim_audit_lab.production_v1.packet import context_from_packet
from claim_audit_lab.production_v1.semantic.authority import AuthorityRefusal, complete_and_warrant
from claim_audit_lab.production_v1.semantic.engine import PassageTrace, audit, compose
...
def test_aperture_observation_is_preserved_but_non_deciding() -> None:
    ...
    assert (
        unknown.evidence_world.evidence_world_sha256 != limited.evidence_world.evidence_world_sha256
    )
