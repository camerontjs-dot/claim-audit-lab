...
AuditPipeline: TypeAlias = Literal["v0.2-lexical", "v1-retrieve-entail"]
"""Which CAL auditor a bundle routes through. See DECISIONS.md § 2026-06-29
(Phase 3 dual-path coexistence). Optional + defaults to ``v0.2-lexical`` so
existing/external bundles route v0.2 unchanged; only bundles that explicitly
opt in (and seal the field into their ``audit_config.config_hash``) reach v1."""
