# ruff: noqa: I001
"""Evaluate frozen structural gate against the fresh post-freeze cohort."""
...
def context_for(case: FreshCase) -> AuditContext:
    proposition = TypedProposition.create(
        proposition_id=f"structural-{case.case_id}",
    ...
    world = EvidenceWorld.create(
        ...
        aperture_observation={"status": "fresh_structural_pressure"},
    )
