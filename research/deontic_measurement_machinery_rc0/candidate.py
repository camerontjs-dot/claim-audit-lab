...
def spacy_dependency(text: str) -> Observation:
    ...
    dependency_negated = any(child.dep_ == "neg" for child in root.children)
    surface_negated = " not " in f" {compact.casefold()} "
    negated = dependency_negated or surface_negated
