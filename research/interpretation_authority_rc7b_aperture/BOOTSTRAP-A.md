# RC7B Fresh Independent Interpretation-Authority Reproduction — Implementation A
...
`research-infra/interpretation-authority-rc7b-a-fresh-20260830`

from the exact aperture head supplied in the launch prompt.

Create implementation only under:

`research/interpretation_authority_rc7b_a/`
...
- `.github/workflows/research-freeze-interpretation-authority-rc7b-a.yml`
...
2. this bootstrap file: `research/interpretation_authority_rc7b_aperture/BOOTSTRAP-A.md`
